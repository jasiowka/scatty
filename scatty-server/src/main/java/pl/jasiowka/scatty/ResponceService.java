 ...
 */
public class ResponceService extends UnicastRemoteObject implements ServerCommands, ServerRemote {
  ...
  public ResponceService(App app) throws RemoteException {
    try {
      this.app = app;
      registry = LocateRegistry.createRegistry(app.getConfig().getRmiPort());
