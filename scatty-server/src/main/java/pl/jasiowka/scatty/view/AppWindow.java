...
public class AppWindow {
	...
	private AppWindow(App app) {
		...
		dictionaryPanel = new DictionaryPanel(app, this,
				multiPanel.getPanel(Panel.Dictionary));
	...
	private Point locationBottomRight() {
		return new Point(screenResolution.width - windowSize.width,
				screenResolution.height - windowSize.height);
	}
